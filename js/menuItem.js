...
class MenuItem {
    ...
    // </div>
    layout() {
        this.DOM.reveal = $(this.DOM.el).find('.hover-reveal')[0];
        this.DOM.revealInner = $(this.DOM.el).find('.hover-reveal__inner')[0];
        this.DOM.revealImage = $(this.DOM.el).find('.hover-reveal__img')[0];
        console.log(this);
    }
    initEvents() {
        this.mouseenterFn = () => {
